...
/**
 * Отключаем блочный редактор (Gutenberg) для страниц: тогда поля ACF
 * показываются крупно и сразу под заголовком (в Gutenberg они прятались
 * в свёрнутую панель «Мета-боксы» внизу). Сайт одностраничный — безопасно.
 */
